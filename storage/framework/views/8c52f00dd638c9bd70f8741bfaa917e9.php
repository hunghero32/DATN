...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default"
    data-assets-path="<?php echo e(asset('admin/assets')); ?>" data-template="vertical-menu-template-free">
...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <?php echo $__env->make('admin.layouts.sidebarMenu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- / Menu -->
    ...
    <script src="<?php echo e(asset('admin/assets/js/pages-account-settings-account.js')); ?>"></script>
    <!-- Place this tag in your head or just before your close body tag. -->
    <script async defer src="https://buttons.github.io/buttons.js"></script>
</body>

</html>
<?php /**PATH C:\laragon\www\DATN\resources\views/admin/index.blade.php ENDPATH**/ ?>