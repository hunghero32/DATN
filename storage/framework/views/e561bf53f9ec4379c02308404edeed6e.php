<?php $__env->startSection('title', 'Thông tin bác sĩ'); ?>
...
<?php $component = App\View\Components\TableListComponent::resolve(['title' => 'Bác sĩ','route' => route('admin.doctors.search'),'columns' => [
        ['key' => 'id', 'label' => 'ID'],
    ...
    ],'data' => $data,'selects' => $selects,'actions' => [
        [
            'label' => 'Thêm mới',
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\DATN\resources\views/admin/pages/doctor/index.blade.php ENDPATH**/ ?>