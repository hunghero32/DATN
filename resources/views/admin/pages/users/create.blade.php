...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Settings /</span> Thêm Admin</h4>
                        ...
                        <form action="{{ route('admin.users.store') }}" method="POST">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="mt-2">
                                    ...
                                    <a href="{{ route('admin.users.index') }}" class="btn btn-outline-secondary">Quaylại</a>
                                </div>
                        </form>
                    </div>
                </div>
