                ...
                <form action="{{ route('admin.notifications.update', $notification->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select id="booking_id" name="booking_id" class="form-control select2">
                                ...
                                @foreach ($bookings as $booking)
                                    <option value="{{ $booking->id }}" {{ $booking->id == $notification->booking_id ? 'selected' : '' }}>{{ $booking->id }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <textarea class="form-control" id="title" name="title">{{ $notification->title }}</textarea>
                        </div>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select id="type" name="type" class="form-control" >
                                ...
                                <option value="booking" {{ $notification->type == 'booking' ? 'selected' : '' }}>Đặt phòng</option>
                                <option value="payment" {{ $notification->type == 'payment' ? 'selected' : '' }}>Thanh toán</option>
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <textarea class="form-control" id="content" name="content">{{ $notification->content }}</textarea>
                        </div>
