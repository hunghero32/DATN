    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          @if(session('success'))
          <div class="bs-toast toast toast-placement-ex m-2 fade show bg-success top-5 start-0" role="alert" aria-live="assertive" aria-atomic="true" data-delay="2000" id="success-toast">
          ...
          <!-- Thông báo lỗi -->
          @if(session('error'))
          <div class="bs-toast toast toast-placement-ex m-2 fade show bg-danger top-5 start-0" role="alert" aria-live="assertive" aria-atomic="true" data-delay="2000" id="error-toast">
            <div class="toast-header">
              <i class="bx bx-bell me-2"></i>
