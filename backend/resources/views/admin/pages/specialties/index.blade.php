...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Chuyên khoa /</span> Danh sách chuyên khoa</h4>
        ...
        <tbody>
            @foreach($specialties as $item)
                <tr>
                    ...
                    <td>
                        @if($item->icon)
                            <img src="{{ asset('storage/' . $item->icon) }}" width="60" height="50">
                        @endif
                    </td>
                    <td>
                        @if($item->image)
                            <img src="{{ asset($item->image) }}" width="100" height="60">
                        @endif
                    </td>
