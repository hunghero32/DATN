                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#showModal{{ $notification->id }}">
                                    Chi tiết
                                </button>
                            </td>
                        </tr>

                        {{-- Include modal tại đây để đảm bảo $notification có giá trị --}}
                        @include('admin.pages.notifications.show', ['notification' => $notification])
                        @endforeach
                    </tbody>
                </table>
